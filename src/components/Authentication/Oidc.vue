...
export default {
	...
	methods: {
		getOidcConfiguration() {
			axios.get(this.$config.VITE_APP_API_ROUTE+"auth_method?name=OIDC", { headers: this.header })
				.then(response => {
		...
		onSubmit(event) {
			...
			axios.patch(this.$config.VITE_APP_API_ROUTE+"auth_config/"+this.oidcdata.id+"/", this.oidcdata,
				{ headers: this.header })
				.then(() => {
